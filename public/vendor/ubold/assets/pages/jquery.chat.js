...
!function($) {
    ...
    ChatApp.prototype.user_save = function(chatText) {
        var chatTime = moment().format("h:mm");
        $('<li class="clearfix"><div class="chat-avatar"><img src="/vendor/ubold/assets/images/avatar-1.jpg" alt="male"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><i>John Deo</i><p>' + chatText + '</p></div></div></li>').appendTo('.conversation-list');
        this.$chatList.scrollTo('100%', '100%', {
            easing: 'swing'
        });
    },
    ChatApp.prototype.bot_save = function(chatText) {
        var chatTime = moment().format("h:mm");
        $('<li class="clearfix odd"><div class="chat-avatar"><img src="/vendor/ubold/assets/images/avatar-1.jpg" alt="male"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><i>John Deo</i><p>' + chatText + '</p></div></div></li>').appendTo('.conversation-list');
        this.$chatList.scrollTo('100%', '100%', {
            easing: 'swing'
        });
    },
